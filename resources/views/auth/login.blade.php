        ...
        <div class="w-[18rem] border border-gray-500 p-6 rounded-md">
            <form action="{{ route('login') }}" method="post" class="flex flex-col gap-3">
                ...
                <div>
                    ...
                    <input type="text" name="username" id="username" value="{{ old('username') }}" class="w-full rounded-md px-2 py-1.5 bg-transparent outline outline-1 outline-gray-500 focus:outline-none focus:ring focus:ring-blue-500">
                    @error('username')
